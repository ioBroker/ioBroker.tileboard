/*
 ...
 Make sure you use real IDs from your ioBroker entities.
*/
         ...
         groups: [
            {
               ...
               items: [
                     ...
                     list: [
                        {
                           ...
                           value: '&javascript.0.devices.valueSimple.val'
                        },
                        {
                           title: 'Custom',
                  ...
                  },
                  {
                     ...
                     width: 1,
                     type: TYPES.SENSOR,
                     id: 'javascript.0.devices.valueSimple',
                     state: '@common.name' // https://github.com/resoai/TileBoard/wiki/Templates
                  }
               ]
            },
               ...
               items: [
                  {
                     ...
                     id: "javascript.0.devices.dimmerSimple",
                     state: false,
                     title: 'Custom slider',
                  ...
                  },
                  {
                     ...
                     width: 1,
                     type: TYPES.SWITCH,
                     id: "javascript.0.devices.lampSimple",
                     //id: {state: 'off'}, // replace it with real string id (e.g. "switch.lights")
                     state: false,
                     title: 'Custom switch',
                     icons: {'false': 'mdi-volume-off', 'true': 'mdi-volume-high'}
                  },
                  {
                     position: [0, 1],
                     type: TYPES.ALARM,
